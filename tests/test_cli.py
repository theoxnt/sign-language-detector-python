...
def test_ask_user_train_classifier_forest_ok(mock_exists, mock_ask_user, mock_action, mock_ask):
...
@patch("src.cli.ask_user")
@patch("src.cli.os.path.exists")
def test_ask_user_train_classifier_neural_network_ok(mock_exists, mock_ask_user, mock_action, mock_ask):
    mock_exists.return_value = True
    mock_ask.side_effect = [
        "3",
        "model_test",
...
@patch("src.cli.ask")
@patch("src.cli.os.path.exists")
def test_ask_user_train_classifier_ko_wrong_train_classifier_name(mock_exists, mock_ask):
    mock_exists.return_value = True
    mock_ask.side_effect = [
        "3",
        "model_test",
    ...
    with pytest.raises(ValueError, match="Invalid option selected. Please enter 'f' or 'n'."):
        ask_user()

@patch("src.cli.ask")
@patch("src.cli.ask_user")
@patch("src.cli.os.path.exists")
def test_ask_user_train_classifier_ko_file_does_not_exists(mock_exists, mock_ask_user, mock_ask):
    ...
    with pytest.raises(RuntimeError, match="Dataset file does not exist. Please create the dataset first."):
        ask_user()

@patch("src.cli.ask")
@patch("src.cli.train_classifier")
@patch("src.cli.os.path.exists")
def test_ask_user_train_classifier_forest_ko_train_classier_did_not_work(mock_exists, mock_action, mock_ask):
    mock_exists.return_value = True
    mock_ask.side_effect = [
        "3",
        "model_test",
...
@patch("src.cli.train_classifier")
@patch("src.cli.os.path.exists")
def test_ask_user_train_classifier_neural_network_ko_train_classier_did_not_work(mock_exists, mock_action, mock_ask):
    mock_exists.return_value = True
    mock_ask.side_effect = [
        "3",
        "model_test",
...
@patch("src.cli.inference_classifier")
@patch("src.cli.ask_user")
def test_ask_user_inference_classifier_neural_network_ok(mock_ask_user, mock_action, mock_ask):
    mock_ask.side_effect = [
        "4",
        "n",
        "5",
...
@patch("src.cli.inference_classifier")
@patch("src.cli.ask_user")
def test_ask_user_inference_classifier_ko_forest_did_not_work(mock_ask_user, mock_action, mock_ask):
    mock_action.return_value = False
    mock_ask.side_effect = [
        "4",
        "f"
...
@patch("src.cli.inference_classifier")
@patch("src.cli.ask_user")
def test_ask_user_inference_classifier_ko_neural_network_did_not_work(mock_ask_user, mock_action, mock_ask):
    mock_action.return_value = False
    mock_ask.side_effect = [
        "4",
        "n"
